...
title: "Getting Started with FAIRVault (Harvard Dataverse)"
...
## Federated Login via Belnet

You can log in using your institutional account through Belnet’s federated access system.
...
If you do not have access via a Belgian university, you may use your **ORCID** account to log in.  

After logging in with ORCID, contact the FAIRVault curators to request dataset creation or editing rights. Provide your ORCID iD so they can link it to your FAIRVault account.
...
1. Navigate to the appointed **Dataverse** where your datasets should reside (e.g., a departmental or project-level dataverse).
...
4. Upload your data files directly or through external storage integrations if available.
5. Save the draft and review the metadata before publishing. Curators may review datasets before they are made public.

![Add data](images/add_data_1.png)

Creating a dataset looks like this:

![Add dataset](images/add_dataset_1.png)
...
- Some files may have restricted access; in that case, you must request access from the dataset owner or curator.
...
- Each dataset page displays **Facts** (metadata such as author, version, DOI, and publication date) on the left-hand side of the screen.
