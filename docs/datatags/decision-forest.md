...
# Decision tree 
By answering the questions of the decision tree, you and the data curators will be able to identify the appropriate sensitivity level for your deposit in the FAIRVault.  
The most stringent sensitivity level that applies to your data will be assigned (least to most stringent: Blue < Green < Orange < Red). In case of an Orange or Red sensitivity level, indicate in FAIRVault **all** legitimate opt-out reasons that apply: 
- Privacy
...
Before starting your upload in FAIRVault, it is important to think about the following: 
   ...
   - Does the dataset contain patient data in the form of full medical records?​
...
![Decision tree for sensitivity of research data](images/FV_DecisionForest_locks_20260810.png)
...
- Does the dataset contain secondary data? Are the data protected by third-party copyright?
  - You should answer 'yes' if the dataset includes secondary data — meaning data originally collected or generated as part of another (research) project or activity  — or if it contains material protected by third-party copyright.
